...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./contact-list.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "contact-list",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "contact-list.deploy.js"
		},
